...
from hyperverlet.datasets import PendulumDataset, SpringMassDataset, ThreeBodySpringMassDataset, ThreeBodyGravityDataset
...
def construct_dataset(config, trainable=True):
    ...
    ds_mapping = dict(pendulum=PendulumDataset, spring_mass=SpringMassDataset, three_body_spring_mass=ThreeBodySpringMassDataset, three_body_gravity=ThreeBodyGravityDataset)
